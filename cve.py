...
def results():
    ...
    try:
        ...
        return render_template('cve1.html', package_name='jquery', package_version='N/A', vulnerabilities=[])

    package_name = 'jquery'  # Default package name to 'jquery'

    vulnerabilities = fetch_vulnerabilities(package_name, package_version)

    return render_template('cve1.html', package_name=package_name, package_version=package_version, vulnerabilities=vulnerabilities)
